 ...
 * 6/6/2007 bcabana Added ability to track axis rendering info and report it
 * 
 */
...
public class PlotRenderingInfo implements Cloneable, Serializable {
    ...
    /** Map from Axis -> AxisRenderingInfo*/
    private Map axisMap;
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        if (this.axisMap != null){
        	clone.axisMap = new HashMap(axisMap);
        }
        return clone;
    }
    ...
    public void putAxisInfo(Axis axis, AxisRenderingInfo info)
    {
        if(axisMap == null)
            axisMap = new HashMap();
        axisMap.put(axis, info);
    }
    
    public AxisRenderingInfo getAxisInfo(Axis axis)
    {
        if(axisMap == null)
            return null;
        return (AxisRenderingInfo)axisMap.get(axis);
    }
}
