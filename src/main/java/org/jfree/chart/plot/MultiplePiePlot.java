 ...
 * 11/20/2007 bcabana QM-7027 if dataset passed into constructor, it should wire it
 * 6/27/2011 bcabana QM-7792 & QM-15419 Pie Chart Label value issues
 */
...
public class MultiplePiePlot extends Plot implements Cloneable, Serializable {
    ...
    public void draw(Graphics2D g2,
        ...
        for (int pieIndex = 0; pieIndex < pieCount; pieIndex++) {
            ...
            if (this.limit > 0.0) {
                piedataset = createConsolodatedPieDataset(dd);
            }
            else {
                piedataset = dd;
            }
    ...
    //6/27/11 bcabana added method
    /**
     * Supports override of the default DatasetUtilities.createConsolidatedPieDataset for QM-7792
     * @param dd
     * @return
     */
    protected PieDataset createConsolodatedPieDataset(PieDataset dd) {
