 ...
 * 6/6/2007 bcabana Added method to get center location of entity
 */
...
public class CategoryItemEntity extends ChartEntity
   ...
   /**
     * Returns the center of the entity.  The default implementation returns the center
     * of the entity bounding box.
     * 
     * @return a point defining the center of the entity
     */
    public Point2D getPointLocation() {
        Rectangle2D bounds = getArea().getBounds2D();
