 ...
 * 7/11/2007 bcabana exposed methods to be able to override
 */
...
public class StackedBarRenderer3D extends BarRenderer3D
     ...
     */
    protected Shape[] createHorizontalBlock(double x0, double width, double y0, 
            double y1, boolean inverted) {
	//Quantrix changed visibility to protected for subclass access
     ...
     * @return The sides of the block.
     */
    protected Shape[] createVerticalBlock(double x0, double width, double y0, 
            double y1, boolean inverted) {
	//Quantrix changed visibility to protected for subclass access
       Shape[] result = new Shape[6];
