 ...
 * 7/30/2007 bcabana Exposed protected method in order to fix issue with ChartLegendEntity not getting correct series index.
 * 
 */
...
public class BarRenderer extends AbstractCategoryItemRenderer
    ...
    protected Point2D calculateLabelAnchorPoint(ItemLabelAnchor anchor,
                                              Rectangle2D bar,
                                              PlotOrientation orientation) {
	//Quantrix changed visibility to protected
        Point2D result = null;
