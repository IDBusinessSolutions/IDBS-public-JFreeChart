 ...
 * 8/27/08	pmurray Buffered charts with resize handling! 
 * 8/28/08	bcabana Don't use image buffer when printing
 */
...
public class ChartPanel extends JPanel implements ChartChangeListener,
    ...
    private Timer bufferResizeTimer;
    ...
    public ChartPanel(JFreeChart chart, int width, int height,
        ...
        this.bufferResizeTimer = new Timer(400, new ActionListener(){
	    @Override
        ...
        bufferResizeTimer.setRepeats(false);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        if (this.useBuffer) {
            ...
            if(chartBufferWidth != available.getWidth() || chartBufferHeight != available.getHeight())
        	bufferResizeTimer.restart();
        }
